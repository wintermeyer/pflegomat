defmodule PflegomatWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PflegomatWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PflegomatWeb.Gettext, "errors", msg, opts)
    end
  end
